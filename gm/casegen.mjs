...
function buildBerlin(seed) {
  ...
  return {
    ...
    preamble: [
      ...
      'Speak plainly — GO somewhere, ASK someone, CHECK a thing. Curiosity',
      'is free; heat comes only from loud moves, and "lay low" cools it.',
      'Your open threads hang in the notebook on the right.',
      '',
