    ...
    stash: {
      ...
      payload: {
        ...
        body: [
          ...
          'duty book for the evening side, and duty books do not know how',
          'to lie. Ask the desk to check the rota.',
        ].join('\n'),
      },
    },
    rota: {
      ...
      payload: {
        ...
        body: [
          ...
          'three were in the building when it moved. Hold the page lightly.',
          'Two more lists and the name stops being an opinion and becomes',
          'arithmetic.',
        ].join('\n'),
      },
    },
    watcherlog: {
      ...
      payload: {
        ...
        body: [
          ...
          'of the two walks away. Put the cards back in the order the night',
          'actually spent them; submit "timeline A B C" as you believe it.',
          '',
          ...T.cards,
          '',
    ...
    site: {
      ...
      payload: {
        ...
        body: [
          ...
          '',
          'Unissued stock does not walk. It does not go for air. It lives',
          `under lock in ${room}, and ${office.name} keeps a key book older`,
          'than the building and twice as honest. Ask who holds keys.',
        ].join('\n'),
      },
    },
    keybook: {
    ...
    herring2: {
      ...
      payload: {
        ...
        body: [
          ...
          `an evening settles it. He ${herring2.clears}.`,
          '',
    ...
    personnel: {
      ...
      payload: {
        ...
        body: [
          ...
          'because from here on the arithmetic is yours to sign.',
          '',
    ...
    resolution: {
      ...
      payload: {
        ...
        body: [
          ...
          'rain has moved on to file down some other quarter of the city,',
          'and the evening desk opens on time, under new management.',
        ].join('\n'),
      },
    },
  }
    ...
    briefing: {
      ...
      payload: {
        ...
        body: [
          ...
          `time to spare. The river gave ${victim} back at Chalmette after`,
          'three days of keeping him, which for that river is sentiment.',
    ...
    stash: {
      ...
      payload: {
        ...
        body: [
          ...
          '  the roster. — T."',
          '',
          'Can\'t reach the roster. A stringer can\'t. You can. Ask the',
          'desk to check it, and check what a records girl will do for',
          'the memory of a sweet boy who tipped.',
        ].join('\n'),
      },
    },
    rota: {
      ...
      payload: {
        ...
        body: [
          ...
          'small. Two more lists and it stops being gossip and becomes',
          'arithmetic — the only clean thing this District produces.',
        ].join('\n'),
      },
    },
    watcherlog: {
    ...
    site: {
      ...
      payload: {
        ...
        body: [
          ...
          'nobody has ever bothered to corrupt because nobody ever',
          'believed it would matter. Ask who holds keys.',
        ].join('\n'),
      },
    },
    keybook: {
    ...
    herring2: {
      ...
      payload: {
        ...
        body: [
          ...
          `evening settles it — he ${herring2.clears}.`,
          '',
    ...
    motive: {
      ...
      payload: {
        ...
        body: [
          ...
          '',
          'That is the whole motive. Not hate. Not a woman. Just',
          'arithmetic, approaching, in city shoes. You are running the',
          'same numbers now with better protection and the same river.',
          'Run them faster than he did.',
        ].join('\n'),
      },
    },
    resolution: {
